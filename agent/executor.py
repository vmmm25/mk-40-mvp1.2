"""MARK XL — Provider-agnostic task executor.

Runs multi-step plans created by the planner module.
Uses the configured AI provider for error analysis and summarization.
"""
...
from agent.error_handler      import generate_fix, ErrorDecision, analyze_error
from agent.llm_helper         import ask_llm_sync
...
def _run_generated_code(description: str, speak: Callable | None = None) -> str:
    ...
    code_prompt = (
        ...
        f"Write clean, complete, working Python code. "
        f"Use standard library + common packages. "
        f"Install missing packages with subprocess + pip if needed. "
    ...
    try:
        code = ask_llm_sync(code_prompt, "").strip()
...
class AgentExecutor:
    ...
    def _summarize(self, goal: str, completed_steps: list, speak: Callable | None) -> str:
        ...
        try:
            ...
            summary = ask_llm_sync(prompt, "").strip()
