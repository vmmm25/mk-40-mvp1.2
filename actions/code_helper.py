...
Code:"""
    ...
    code = client.chat(prompt, system="You are a code generator. Output only raw code, no markdown, no backticks.")
...
Fixed code:"""
    ...
    try:
        fixed = client.chat(prompt, system="You are a code generator. Output only raw code, no markdown, no backticks.")
...
Updated code:"""
    ...
    try:
        edited = client.chat(prompt, system="You are a code editor. Output only raw code, no markdown, no backticks.")
...
Explanation:"""
    ...
    try:
        return client.chat(prompt, system="You are a code reviewer. Be clear and concise.")
    except Exception as e:
...
Optimized code:"""
    ...
    try:
        optimized = client.chat(prompt, system="You are a code optimizer. Output only raw code, no markdown, no backticks.")
