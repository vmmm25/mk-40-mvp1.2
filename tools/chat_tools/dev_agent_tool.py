...
class DevAgentTool(BaseTool):
    ...
    parameters = {'type': 'OBJECT', 'properties': {'description': {'type': 'STRING', 'description': 'What the project should do'}, 'language': {'type': 'STRING', 'description': 'Programming language (default: python)'}, 'project_name': {'type': 'STRING', 'description': 'Optional project folder name'}, 'timeout': {'type': 'INTEGER', 'description': 'Run timeout in seconds (default: 30)'}}, 'required': ['description']}
